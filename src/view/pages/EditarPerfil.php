			...
			<form class="form" action="/perfil/editar/process" method="POST" enctype="multipart/form-data">
				...
				<div class="form-fields-container">
					...
					<div class="form-side-container form-left-container">
						...
						<input class="input" type="text" id="name" name="nome" placeholder="Nome" value="<?php echo $usuario['nome'] ?>"><br><br>

						<label class="label" for="sobrenome">Sobrenome:</label>
						<input class="input" type="sobrenome" id="sobrenome" name="sobrenome" placeholder="Sobrenome" value="<?php echo $usuario['sobrenome'] ?>"><br><br>

						<label class="label" for="name">Telefone:</label>
						<input class="input" type="text" id="name" name="telefone" placeholder="Telefone" value="<?php echo $usuario['telefone'] ?>"><br><br>
					...
					<div class="form-side-container form-right-container">
						...
						<input class="input" type="date" id="birthday" name="nascimento" value="<?php echo $usuario['data_nascimento'] ?>"><br><br>

						<label class="label" for="name">Estado:</label>
						<input class="input" type="text" id="name" name="estado" placeholder="Estado" value="<?php echo $usuario['estado'] ?>"><br><br>

						<label class="label" for="name">Cidade:</label>
						<input class="input" type="text" id="name" name="cidade" placeholder="Cidade" value="<?php echo $usuario['cidade'] ?>"><br><br>

						<label class="label" for="name">Endereço:</label>
						<input class="input" type="text" id="name" name="endereco" placeholder="Endereço" value="<?php echo $usuario['endereco'] ?>"><br><br>
